package com.android.chatty.Receivers;

import java.net.InetAddress;
import java.util.ArrayList;
import java.util.List;

import com.android.chatty.WifiP2PActivity;
...
public class WifiDirectBroadcastReceiver extends BroadcastReceiver{
	...
	public void activateGoToChat(String role){
		if(mActivity.getClass() == WifiP2PActivity.class){
			((WifiP2PActivity)mActivity).getGoToChat().setText("Start the chat "+role);
			((WifiP2PActivity)mActivity).getGoToChat().setVisibility(View.VISIBLE);
			((WifiP2PActivity)mActivity).getSetChatName().setVisibility(View.VISIBLE);
			((WifiP2PActivity)mActivity).getSetChatNameLabel().setVisibility(View.VISIBLE);
			((WifiP2PActivity)mActivity).getDisconnect().setVisibility(View.VISIBLE);
			((WifiP2PActivity)mActivity).getGoToSettings().setVisibility(View.GONE);
			((WifiP2PActivity)mActivity).getGoToSettingsText().setVisibility(View.GONE);
